...
urlpatterns = [
    ...
    path('atletas/existente/', AgregarAtletaExistente.get_form, name='agregar_atleta_existente'),
    path('atletas/existente/ok/', AgregarAtletaExistente.agregar_atleta, name='atleta_existente_agregado'),
    path('atletas/<int:pk>/editar/', EditarAtleta.get_form, name='editar_atleta'),
    path('atletas/<int:pk>/editado/', EditarAtleta.editar_atleta, name='atleta_editado'),
    path('atletas/<int:pk>/eliminar/', EliminarAtleta.as_view(), name='eliminar_atleta'),
    path('atletas/<int:pk>/microciclos/', ListaMicrociclos.get_vista, name='microciclos_atleta'),
    ...
    path('atletas/<int:pk>/microciclos/nuevo/', AgregarMicrociclo.get_form, name='agregar_microciclo'),
    path('atletas/<int:pk>/microciclos/agregado/', AgregarMicrociclo.agregar_microciclo, name='atleta_microciclo_agregado'),
    path('atletas/<int:pk1>/microciclos/<int:pk2>/dias_entrenamiento/', ListaDiasEntrenamiento.get_vista, name='dias_entrenamiento'),
    path('atletas/<int:pk1>/microciclos/<int:pk2>/dias_entrenamiento/nuevo/', AgregarDia.get_form, name='agregar_dia'),
    path('atletas/<int:pk1>/microciclos/<int:pk2>/dias_entrenamiento/agregado/', AgregarDia.agregar_dia, name='dia_agregado'),
    ...
    path('atletas/<int:pk1>/microciclos/<int:pk2>/dias_entrenamiento/<int:pk3>/nuevo_ejercicio/', AgregarEjercicioDia.get_form, name='agregar_ejercicio_dia'),
    ...
    path('atletas/<int:pk1>/microciclos/<int:pk2>/dias_entrenamiento/<int:pk3>/ok', AgregarEjercicioDia.agregar_ejercicio, name='ejercicio_dia_agregado'),
    ...
    path('entrenadores/existente/', AgregarEntrenadorExistente.get_form, name='agregar_entrenador_existente'),
    path('entrenadores/existente/ok/', AgregarEntrenadorExistente.agregar_entrenador, name='entrenador_existente_agregado'),
    path('entrenadores/<int:pk>/editar/', EditarEntrenador.get_form, name='editar_entrenador'),
    path('entrenadores/<int:pk>/editado/', EditarEntrenador.editar_entrenador, name='entrenador_editado'),
